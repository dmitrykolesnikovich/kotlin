...
abstract class MultiplePluginVersionGradleImportingTestCase : ExternalSystemImportingTestCase() {
    ...
    protected fun configureKotlinVersionAndProperties(text: String, properties: Map<String, String>? = null): String {
        var result = text
        (properties ?: mapOf(
            "kotlin_plugin_version" to gradleKotlinPluginVersion,
            "kotlin_plugin_repositories" to repositories(false),
            "kts_kotlin_plugin_repositories" to repositories(true)
        )).forEach { (key, value) ->
    ...
    protected fun getDefaultPropertiesMap(): Map<String, String> {
    ...
    companion object {
        ...
        private const val LATEST_STABLE_RELEASE_GRADLE_PLUGIN_VERSION = "1.4.30"
        ...
        private const val LATEST_SUPPORTED_GRADLE_VERSION = "6.5.1"
        private val SUPPORTED_GRADLE_VERSIONS = arrayOf("4.9", "5.6.4", LATEST_SUPPORTED_GRADLE_VERSION)
